...
<html <?php bloginfo('language_attributes'); ?>>
  <head>
    ...
    <link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/styles.css">
    <style>
    #view-source {
      position: fixed;
      display: block;
  ...
  <body class="mdl-demo mdl-color--grey-100 mdl-color-text--grey-700 mdl-base">
    ...
    <script src="<?php bloginfo('template_directory'); ?>/assets/material.min.js"></script>
  </body>
</html>
