						...
						<div class="container">
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Feature #1 -->
										<section>
											<a href="#" class="bordered-feature-image"><img src="<?php bloginfo('template_directory'); ?>/images/pic01.jpg" alt="" /></a>
								...
								<div class="3u 12u(mobile)">
									...
									<!-- Feature #2 -->
										<section>
											<a href="#" class="bordered-feature-image"><img src="<?php bloginfo('template_directory'); ?>/images/pic02.jpg" alt="" /></a>
								...
								<div class="3u 12u(mobile)">
									...
									<!-- Feature #3 -->
										<section>
											<a href="#" class="bordered-feature-image"><img src="<?php bloginfo('template_directory'); ?>/images/pic03.jpg" alt="" /></a>
											<h2>License Info</h2>
											<p>
								...
								<div class="3u 12u(mobile)">
									...
									<!-- Feature #4 -->
										<section>
											<a href="#" class="bordered-feature-image"><img src="<?php bloginfo('template_directory'); ?>/images/pic04.jpg" alt="" /></a>
								...
								<div class="4u 12u(mobile)">
									...
									<!-- Box #1 -->
										<section>
											...
											<a href="#" class="feature-image"><img src="<?php bloginfo('template_directory'); ?>/images/pic05.jpg" alt="" /></a>
											<p>
									...
									<!-- Box #3 -->
										<section>
											...
											<ul class="quote-list">
												...
												<li>
													<img src="<?php bloginfo('template_directory'); ?>/images/pic07.jpg" alt="" />
													<p>"Lorem ipsum consequat!"</p>
													<span>John Doe, President of FakeBiz</span>
												</li>
												<li>
													<img src="<?php bloginfo('template_directory'); ?>/images/pic08.jpg" alt="" />
