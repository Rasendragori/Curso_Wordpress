<?php
	...
	if (empty($_SESSION['logueado'])) {
		...
		<body background='../img/marcianito100realnofeik.gif' style='text-align:center;padding:40px;cursor: url(http://cur.cursors-4u.net/games/gam-10/gam948.png), pointer;'>
			<div class='form-bottom'>
				<img src='../img/error403wow.jpg'><br>
				...
				<img src='../img/tenor.gif'><br><br>
				<img src='../img/altoahi.jpg'><br><br>
				<img src='../img/pepelaranabailando.gif'>
				<img src='../img/Rana multicolor.gif'><br><br>
