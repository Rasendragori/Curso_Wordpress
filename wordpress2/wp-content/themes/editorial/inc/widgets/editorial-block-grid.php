...
add_action( 'widgets_init', 'editorial_register_block_gird_widget' );

function editorial_register_block_gird_widget() {
...
class Editorial_Block_Grid extends WP_Widget {
    ...
    global $editorial_category_dropdown, $editorial_grid_columns;
